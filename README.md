...
## ROS Packages for ROBOTIS THORMANG3 Messages
|Version|Kinetic + Ubuntu Xenial|Melodic + Ubuntu Bionic|
|:---:|:---:|:---:|
|[![GitHub version](https://badge.fury.io/gh/ROBOTIS-GIT%2FROBOTIS-THORMANG-msgs.svg)](https://badge.fury.io/gh/ROBOTIS-GIT%2FROBOTIS-THORMANG-msgs)|[![Build Status](https://travis-ci.org/ROBOTIS-GIT/ROBOTIS-THORMANG-msgs.svg?branch=kinetic-devel)](https://travis-ci.org/ROBOTIS-GIT/ROBOTIS-THORMANG-msgs)|-|
...
## Wiki for thormang3_msgs Packages
- http://wiki.ros.org/thormang3_msgs (metapackage)
- http://wiki.ros.org/thormang3_action_module_msgs
- http://wiki.ros.org/thormang3_feet_ft_module_msgs
- http://wiki.ros.org/thormang3_head_control_module_msgs
- http://wiki.ros.org/thormang3_manipulation_module_msgs
- http://wiki.ros.org/thormang3_offset_tuner_msgs
- http://wiki.ros.org/thormang3_walking_module_msgs
